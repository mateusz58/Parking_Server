...
class Parking_Serializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'parking_name', 'parking_Street', 'parking_City', 'x', 'y', 'free_places', 'HOUR_COST',
                  'number_of_places', 'user_parking')
        read_only_fields = (
        'id', 'x', 'y', 'parking_name', 'parking_City', 'free_places', 'parking_Street', 'user_parking')
...
class Car_booking_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = (
        'id', 'parking', 'Cost', 'user', 'number_of_cars', 'booking', 'Date_From', 'Date_To', 'active', 'Parking_name',
        'Parking_street', 'Parking_city',)
