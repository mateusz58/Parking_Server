...
class Parking_Admin(admin.ModelAdmin):
    list_display = ['parking_name', 'parking_Street', 'parking_City', 'free_places']
...
class Booking_admin(admin.ModelAdmin):
        list_display = ['code', 'parking', 'user', 'Date_From','Date_To','Cost','registration_plate']
        ordering = ['Date_From']
        search_fields = ('code','user__email','parking__parking_name','registration_plate')
