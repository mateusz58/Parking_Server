# Generated by Django 2.1.4 on 2019-02-09 03:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_cars', models.PositiveIntegerField(default=0, editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='Car',
            fields=[
                ...
                ('Date_From', models.DateTimeField(default=datetime.datetime(2019, 2, 9, 4, 56, 12, 464397))),
                ('Date_To', models.DateTimeField(default=datetime.datetime(2019, 2, 9, 4, 56, 12, 464397))),
                ...
                ('Cost', models.FloatField(default=0, editable=False)),
                ('booking', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='booking', to='pages.Booking')),
            ],
        ),
        migrations.CreateModel(
            name='Parking',
